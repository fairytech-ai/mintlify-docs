...
| 헤더명 | 필수여부 | 설명 |
| :-- | :-- | :-- |
| x-moment-api-key | O | Fairy에서 제공한 Server API Key |
...
`{ORGANIZATION_PUBLIC_ID}`에는 Fairy에서 제공한 고객사 ID를 입력합니다. 값을 제공받지 못했다면 [eng@fairytech.ai](mailto:eng@fairytech.ai)로 문의하세요.
